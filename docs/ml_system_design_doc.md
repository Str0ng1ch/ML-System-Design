...
- **Бизнес-цель**: повысить глубину и академическую насмотренность студенческих работ по урбанистике, снизив при этом
  нагрузку на преподавателей по рутинной проверке и выдаче однотипных комментариев.
- **Почему станет лучше, чем сейчас, от использования ML**: AI-ассистент будет предоставлять быструю и содержательную
  обратную связь, побуждающую студентов работать с первоисточниками, что приведет к качественному улучшению их работ.
...
- Что не будет закрыто:
    1. все остальное, что не написано в пункте 1.3.1 :)
- Описание результата с точки зрения качества кода и воспроизводимости решения: код модульный, задокументирован,
  упакован в Docker-контейнеры для обеспечения воспроизводимости.
